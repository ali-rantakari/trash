...
trash: $(SOURCE_FILES)
	...
	@echo ---- Compiling:
	@echo ======================================
	$(CC) -O2 -Wall -Wextra -Wpartial-availability -force_cpusubtype_ALL -mmacosx-version-min=10.5 -arch i386 -arch x86_64 -framework AppKit -framework ScriptingBridge -o $@ $(SOURCE_FILES)
